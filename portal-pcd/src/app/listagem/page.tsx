...
export default async function ListagemPage() {
  ...
  return (
    <main style={{padding:'2rem'}}>
        <h1 className="text-center mt-10 text-4xl font-bold text-gray-800">Bem Vindo ao Portal PCD</h1>
        
        <p className="text-center mt-2 text-2xl font-bold text-gray-700">Acesse os conteúdos</p>
